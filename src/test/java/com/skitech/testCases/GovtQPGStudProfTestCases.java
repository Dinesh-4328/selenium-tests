...
public class GovtQPGStudProfTestCases extends BaseClass{
    ...
    String validPDFFile = "C:\\Users\\SivachandranK\\Desktop\\Backups\\pdfDownload (1).pdf";
    String invalidFileType = "C:\\Users\\SivachandranK\\Desktop\\Backups\\Vivek_krishnakumar_QA_Engineer.docx";
    String hugeFileSize = "C:\\Users\\SivachandranK\\Desktop\\Backups\\200MB-TESTFILE.ORG.pdf";
    String imageFile="C:\\Users\\SivachandranK\\Desktop\\Backups\\download.jpg";
	String downloadPath = "C:\\Users\\SivachandranK\\Downloads";
	...
	public void TC_MQLSP_011_Verify_sending_6_digit_code_with_valid_email() throws IOException, InterruptedException{
		...
		uploadFilePOM.uploadValidGovtQuotaFileTemplate("Postgraduate","First Year","General");
...
//	@Test(groups= {"Regression","TC002"},priority=2)
//	public void TC_MQLSP_012_Verify_sending_6_digit_code_fails_if_email_is_not_recognized(){
//		
...
//	}
//	
	@Test(groups= {"Regression","TC003"},priority=3)
	public void TC_MQLSP_013_Verify_student_profile_signin_with_invalid_OTP(){
...
//	
//	@Test(groups= {"Regression","TC004"},priority=4)
//	public void TC_MQLSP_014_Verify_student_profile_account_signin_with_expired_OTP(){
//		
...
//	}
//	
//	@Test(groups= {"Regression","TC005"}, priority=5)
//	public void TC_MQLSP_015_Verify_Resend_Code_in_sign_in_screen() {
//		
...
//	}
//	
//	@Test(groups= {"Regression","TC006"}, priority=6)
//	public void TC_MQLSP_016_Verify_Go_back_in_sign_in_screen() {
//		
...
//	
	...
	public void TC_MQLSP_017_Verify_student_profile_account_signin_with_valid_OTP(){
...
//	@Test(groups= {"Regression","TC008"}, priority=8)
//	public void TC_MQLSP_018_Verify_personal_details_tab() {
//		
...
//	}
//		
//	@Test(groups= {"Regression","TC009"}, priority=9)
//	public void TC_MQLSP_019_Verify_mandatory_alerts_in_add_personal_details_tab() {
//		
...
//	}
//	
//	@Test(groups= {"Regression","TC010"}, priority=10)
//	public void TC_MQLSP_020_Verify_add_personal_details() {
//		
...
//		studentsProfilePOM.selectCommunity("BC");
...
//	}
//	
//	@Test(groups= {"Regression", "TC011"}, priority=11)
//	public void TC_MQLSP_021_Verify_add_personal_details_with_invalid_data() {
//		
...
//	}
//	
//	@Test(groups= {"Regression","TC012"}, priority=12)
//	public void TC_MQLSP_025_Verify_upload_physically_challenged_and_income_certificate_with_invalid_file_types() {
//		
...
//	public void TC_MQLSP_027_Verify_upload_physically_challenged_income_certificate_with_file_size_more_than_5mb() {
//		
...
//	public void TC_MQLSP_028_Verify_personal_details_go_to_home_button() {
//		
...
//	
	...
	public void TC_MQLSP_029_Verify_next_step_in_personal_details_tab() {
	...
	public void TC_MQLSP_030_Verify_academic_details_tab() {
	...
	public void TC_MQLSP_031_Verify_mandatory_alerts_in_add_academic_details_tab() {
...
//	public void TC_MQLSP_032_Verify_add_academic_details_with_invalid_data() {
//		
...
//	}
	...
	public void TC_MQSPG_033_Verify_add_academic_details_with_10th_HSC1_Diploma_UG() {
		...
		studentsProfilePOM.tickChkBoxSelectifyouhavecompletedDiploma();
		...
		studentsProfilePOM.selectDegree("Bachelor of Science (B.Sc.)");
		studentsProfilePOM.selectCountry("India");
		studentsProfilePOM.selectState("Tamil Nadu");
		studentsProfilePOM.selectCourseType("Regular");
		StudentsProfilePOM.selectBoardOfStudy("Deemed University");
		StudentsProfilePOM.selectCollege("A R M College Of Engineering And Technology, Kancheepuram");
	StudentsProfilePOM.enterOtherCollegeName("Other Test College");
		StudentsProfilePOM.selectBranchDepartment("Tamil");
		StudentsProfilePOM.selectMonthOfPassing("March");
		StudentsProfilePOM.selectYearOfPassing("2022");

        // Text fields
		StudentsProfilePOM.enterUMISNo("UMIS12345");
		StudentsProfilePOM.enterExamRegisterNo("EXAM98765");

        // Semester marks (example)
		StudentsProfilePOM.enterMarksScored(1, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(1, semTotalMarks);

		StudentsProfilePOM.enterMarksScored(2, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(2, semTotalMarks);
		
		StudentsProfilePOM.enterMarksScored(3, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(3, semTotalMarks);
		
		StudentsProfilePOM.enterMarksScored(4, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(4, semTotalMarks);
		
		StudentsProfilePOM.enterMarksScored(5, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(5, semTotalMarks);
		
		StudentsProfilePOM.enterMarksScored(6, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(6, semTotalMarks);
		
		StudentsProfilePOM.enterMarksScored(7, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(7, semTotalMarks);
		
		StudentsProfilePOM.enterMarksScored(8, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(8, semTotalMarks);
		
		StudentsProfilePOM.enterMarksScored(9, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(9, semTotalMarks);

		StudentsProfilePOM.enterMarksScored(10, randomSemMarksScored);
		StudentsProfilePOM.enterTotalMarks(10, semTotalMarks);

		
        // Overall details
		StudentsProfilePOM.enterOverallMarksScored(randomSemMarksScored);
		StudentsProfilePOM.enterOverallTotalMarks(semTotalMarks);
		studentsProfilePOM.enterOverallPercentagePg(fake.number().digits(2));
	...
	public void TC_MQSPG_034_Verify_add_academic_details_with_10th_HSC1_HSC2_Diploma_UG() {
	...
	public void TC_MQSPG_035_Verify_add_academic_details_with_10th_Diploma_PG() {
	...
	public void TC_MQSPG_036_Verify_add_academic_details_with_Diploma_Course_Type_Lateral() {
	...
	public void TC_MQLSP_037_Verify_add_academic_details_with_diploma_course_type_sandwich_7_semesters() {
	...
	public void TC_MQLSP_038_Verify_add_academic_details_with_diploma_course_type_sandwich_8_semesters() {
	...
	public void TC_MQLSP_039_Verify_add_academic_details_with_diploma_course_type_sandwich_lateral_7_semesters() {
	...
	public void TC_MQLSP_040_Verify_add_academic_details_with_diploma_course_type_sandwich_lateral_8_semesters() {
		...
		public void TC_MQSPG_041_Verify_add_academic_details_by_uploading_invalid_file_types() {
		
		stepInfo("Verify_add_academic_details_by_uploading_invalid_file_types");
		...
		public void TC_MQLSP_042_Verify_Upload_mark_sheet_document_more_than_5_mb() {
...
//		public void TC_MQLSP_043_Verify_academic_details_Go_to_Home() {
//		
...
//	public void TC_MQLSP_045_Verify_family_details_tab() {
//		
...
//	public void TC_MQLSP_046_Verify_mandatory_field_alert_in_add_family_details_tab() {
//		
...
//	public void TC_MQLSP_047_Verify_add_family_details_with_invalid_data() {
//		
...
//	public void TC_MQLSP_048_Verify_add_family_details_with_family_type_as_with_parents() {
//		
...
//	public void TC_MQLSP_049_Verify_add_family_details_with_family_type_as_single_parent_with_mother() {
//		
...
//	public void TC_MQLSP_050_Verify_add_family_details_with_family_type_as_single_parent_with_father() {
//		
...
//	public void TC_MQLSP_051_Verify_add_family_details_with_family_type_as_with_guardian() {
//		
...
//	public void TC_MQLSP_047_Verify_with_No_in_Has_any_of_your_siblings_joined_this_institution_before_fields() {
//	
...
//	public void TC_MQLSP_048_Verify_add_family_details_with_do_you_have_siblings_as_No() {
//		
...
//	public void TC_MQLSP_056_Verify_mandatory_fields_in_siblings() {
//		
...
//	public void TC_MQLSP_057_Verify_add_sibling_with_invalid_data() {
//		
...
//	public void TC_MQLSP_058_Verify_add_sibling_with_valid_data() {
//		
...
//	public void TC_MQLSP_059_Verify_add_another_sibling() {
//		
...
//	public void TC_MQLSP_061_Verify_update_siblings() {
//		
...
//	public void TC_MQLSP_062_Verify_remove_siblings() {
//		
...
//	public void TC_MQLSP_064_Verify_Go_To_Home_Button_in_family_details() {
//		
...
//	public void TC_MQLSP_065_Verify_address_details_tab() {
//		
...
//	public void TC_MQLSP_066_Verify_mandatory_fields_in_address_details_tab() {
//		
...
//	public void TC_MQLSP_067_Verify_address_details_with_invalid_data() {
//		
//		stepInfo("Verify_address_details_with_invalid_data");
//		
//		softAssert = new SoftAssert();
//		
//		driver.navigate().refresh();
...
//	public void TC_MQLSP_068_Verify_add_address_details() {
//		
//		stepInfo("Verify_add_address_details");
//		
//		softAssert = new SoftAssert();
//		
...
//	public void TC_MQLSP_069_Verify_Communication_address_is_same_as_permanent_address() {
//		
...
//	
	...
	public void TC_MQLSP_070_Verify_go_to_home_in_address_details() {
	...
	public void TC_MQLSP_072_Verify_Admission_Details_tab() {
	...
	public void TC_MQLSP_073_Verify_admission_details_tab_mandatory_fields() {
	...
	public void TC_MQLSP_074_Verify_add_admission_details_with_invalid_data() {
		
		stepInfo("Verify_add_admission_details_with_invalid_data");
		
		softAssert = new SoftAssert();
		
		studentsProfilePOM.enterTNMBAadmissionnofield("sdds*&%");	
		studentsProfilePOM.enterTANCETadmissionnofield("sdds*&%");
		studentsProfilePOM.enterTANCETmarkfield("sdd*%^");
		studentsProfilePOM.clickOnSaveandNextButton();
	...
	public void TC_MQLSP_075_Verify_add_admission_details_with_valid_data() {
		
		stepInfo("Verify_add_admission_details_with_valid_data");
		
		softAssert = new SoftAssert();
		
		studentsProfilePOM.enterTNMBAadmissionnofield("25001234");
		studentsProfilePOM.enterTANCETadmissionnofield("76878789");	
		//studentsProfilePOM.enterPaymentId(fake.number().digits(6));
		studentsProfilePOM.enterTANCETmarkfield("780");
	...
	public void TC_MQLSP_076_Verify_add_admission_details_with_dayscholar_college_transport() {
	...
	public void TC_MQLSP_077_Verify_add_admission_details_with_dayscholar_for_personal_transport_for_two_wheeler() {
	...
	public void TC_MQLSP_078_Verify_add_admission_details_with_dayscholar_for_personal_transport_for_four_wheeler() {
	...
	public void TC_MQLSP_079_Verify_add_admission_details_with_dayscholar_for_personal_transport_for_Pickup_and_Drop_by_Parents() {
	...
	public void TC_MQLSP_080_Verify_add_admission_details_with_dayscholar_public_transport() {
	...
	public void TC_MQLSP_081_Verify_upload_consortium_application_with_invalid_file_type() {
		
		stepInfo("Verify_upload_consortium_application_with_valid_file_type");
		
		softAssert = new SoftAssert();
		
		studentsProfilePOM.clickOnPreviousButton();
		studentsProfilePOM.uploadConsortiumApplication(invalidFileType);
	...
	public void TC_MQLSP_082_Verify_upload_consortium_application_with_more_than_5mb_file() {
		
		stepInfo("Verify_upload_consortium_application_with_more_than_5mb_file");
		
		softAssert = new SoftAssert();
		
		studentsProfilePOM.uploadConsortiumApplication(hugeFileSize);
	...
	public void TC_MQLSP_083_Verify_upload_consortium_application_with_valid_file_type() {
		
		stepInfo("Verify_upload_consortium_application_with_valid_file_type");
		
		softAssert = new SoftAssert();
		
		studentsProfilePOM.uploadConsortiumApplication(validPDFFile);
		studentsProfilePOM.clickOnSaveandNextButton();
	...
	public void TC_MQLSP_084_Verify_upload_RC_and_License_for_two_wheeler_with_valid_file() {
	...
	public void TC_MQLSP_085_Verify_upload_RC_and_License_for_two_wheeler_with_invalid_file() {
	...
	public void TC_MQLSP_086_Verify_upload_RC_and_License_for_two_wheeler_with_more_than_5_mb() {
	...
	public void TC_MQLSP_087_Verify_upload_RC_and_License_for_four_wheeler_with_valid_file() {
	...
	public void TC_MQLSP_088_Verify_upload_RC_and_License_for_four_wheeler_with_invalid_file() {
	...
	public void TC_MQLSP_089_Verify_upload_RC_and_License_for_four_wheeler_with_more_than_5_mb() {
	...
	public void TC_MQLSP_090_Verify_add_admission_details_with_go_to_Home() {
	...
	public void TC_MQLSP_092_Verify_Documents_details_tab() {
	...
	public void TC_MQLSP_095_Verify_mandatory_alerts_in_document_details_tab() {
	...
	public void TC_MQLSP_097_Verify_Upload_columns_by_uploading_invalid_file_type_for_all_documents_sections() {
	...
	public void TC_MQLSP_098_Verify_Upload_columns_by_uploading_more_than_5mb() {
	...
	public void TC_MQLSP_099_Verify_Upload_valid_file_in_all_document_sections_in_document_tab() {
	...
	public void TC_MQLSP_0100_Verify_view_all_document_sections_in_document_tab() {
...
//		System.out.println(studentsProfilePOM.getSuccessToasterAlert());
	...
	public void TC_MQLSP_101_Verify_remove_documents_in_all_document_sections() {
		
		stepInfo("Verify_remove_documents_in_all_document_sections");
	...
	public void TC_MQLSP_102_Verify_previous_step_in_documents_tab() {
	...
	public void TC_MQLSP_103_Verify_go_to_home_in_documents_tab() {
	...
	public void TC_MQLSP_104_Verify_preview_tab_sections() {
	...
	public void TC_MQLSP_111_Verify_submit_button_in_preview_tab_if_leaving_mandatory_field_or_document_or_any_section() {
	...
	public void TC_MQLSP_112_Verify_submit_button_in_preview_tab() {
