...
public class ManagQPGStudProfTestCase extends BaseClass{
	...
	uploadFilePOM.selectQuota("Management quota");
		uploadFilePOM.uploadValidManagementQuotaFileTemplate("Postgraduate", "First Year");
...
//	
	...
	public void TC_MQLSP_074_Verify_add_admission_details_with_invalid_data() {
		...
		studentsProfilePOM.enterPaidAmount("sdds*&%");	
		studentsProfilePOM.enterPaymentId("sdds*&%");
		studentsProfilePOM.clickOnSaveandNextButton();
	...
	public void TC_MQLSP_075_Verify_add_admission_details_with_valid_data() {
		...
		studentsProfilePOM.selectPaymentMode("DD");
		studentsProfilePOM.enterPaidAmount("500");	
		studentsProfilePOM.enterPaymentId(fake.number().digits(6));
		studentsProfilePOM.enterPaidOn(formattedDate);
